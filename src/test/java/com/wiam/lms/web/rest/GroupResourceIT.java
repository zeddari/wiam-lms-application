...
class GroupResourceIT {
    ...
    public static Group createEntity(EntityManager em) {
        Group group = new Group().nameAr(DEFAULT_NAME_AR).nameLat(DEFAULT_NAME_LAT).description(DEFAULT_DESCRIPTION);
        return group;
    }
    ...
    public static Group createUpdatedEntity(EntityManager em) {
        Group group = new Group().nameAr(UPDATED_NAME_AR).nameLat(UPDATED_NAME_LAT).description(UPDATED_DESCRIPTION);
        return group;
    }
    ...
    void putExistingGroup() throws Exception {
        ...
        updatedGroup.nameAr(UPDATED_NAME_AR).nameLat(UPDATED_NAME_LAT).description(UPDATED_DESCRIPTION);
    ...
    void partialUpdateGroupWithPatch() throws Exception {
        ...
        partialUpdatedGroup.nameAr(UPDATED_NAME_AR).nameLat(UPDATED_NAME_LAT);
