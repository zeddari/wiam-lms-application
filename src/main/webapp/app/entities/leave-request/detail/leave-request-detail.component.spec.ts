...
describe('LeaveRequest Management Detail Component', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [LeaveRequestDetailComponent, RouterTestingModule.withRoutes([], { bindToComponentInputs: true })],
      providers: [
        provideRouter(
          [
            {
  ...
  describe('byteSize', () => {
    it('Should call byteSize from DataUtils', () => {
      ...
      const fixture = TestBed.createComponent(LeaveRequestDetailComponent);
