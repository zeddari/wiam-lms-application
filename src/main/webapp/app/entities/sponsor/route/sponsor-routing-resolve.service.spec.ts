...
import sponsorResolve from './sponsor-routing-resolve.service';

describe('Sponsor routing resolve service', () => {
  let mockRouter: Router;
  let mockActivatedRouteSnapshot: ActivatedRouteSnapshot;
  let service: SponsorService;
  let resultSponsor: ISponsor | null | undefined;
  ...
  describe('resolve', () => {
    it('should return ISponsor returned by find', () => {
      ...
      TestBed.runInInjectionContext(() => {
        sponsorResolve(mockActivatedRouteSnapshot).subscribe({
          next(result) {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultSponsor).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<ISponsor>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
