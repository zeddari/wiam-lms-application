...
import { SessionService, RestSession } from './session.service';

const requireRestSample: RestSession = {
  ...sampleWithRequiredData,
  sessionStartTime: sampleWithRequiredData.sessionStartTime?.toJSON(),
  sessionEndTime: sampleWithRequiredData.sessionEndTime?.toJSON(),
  onceDate: sampleWithRequiredData.onceDate?.toJSON(),
  periodStartDate: sampleWithRequiredData.periodStartDate?.format(DATE_FORMAT),
  periodeEndDate: sampleWithRequiredData.periodeEndDate?.format(DATE_FORMAT),
};
...
describe('Session Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should handle exceptions for searching a Session', () => {
