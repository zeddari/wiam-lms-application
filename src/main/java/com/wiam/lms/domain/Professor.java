...
public class Professor implements Serializable {
    ...
    @OneToMany(fetch = FetchType.LAZY, mappedBy = "professor1")
    @Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
    ...
    public Professor phoneNumber(String phoneNumber) {
    ...
    public Professor mobileNumber(String mobileNumber) {
    ...
    public Professor gender(Boolean gender) {
    ...
    public Professor about(String about) {
        this.setAbout(about);
        return this;
    }
    ...
    public Professor imageLink(byte[] imageLink) {
    ...
    public Professor imageLinkContentType(String imageLinkContentType) {
    ...
    public Professor code(String code) {
        this.setCode(code);
        return this;
    }
    ...
    public Professor birthdate(LocalDate birthdate) {
    ...
    public Professor lastDegree(String lastDegree) {
    ...
    public Professor userCustom(UserCustom userCustom) {
    ...
    public void setCourses(Set<Course> courses) {
        if (this.courses != null) {
            this.courses.forEach(i -> i.setProfessor1(null));
        }
        if (courses != null) {
            courses.forEach(i -> i.setProfessor1(this));
        }
    ...
    public Professor addCourse(Course course) {
        ...
        course.setProfessor1(this);
        return this;
    }

    public Professor removeCourse(Course course) {
        this.courses.remove(course);
        course.setProfessor1(null);
        return this;
    }
    ...
    public void setSessions(Set<Session> sessions) {
        if (this.sessions != null) {
            this.sessions.forEach(i -> i.removeProfessors(this));
        }
        if (sessions != null) {
    ...
    public Professor sessions(Set<Session> sessions) {
        this.setSessions(sessions);
        return this;
    }

    public Professor addSession(Session session) {
        this.sessions.add(session);
        session.getProfessors().add(this);
        return this;
    }

    public Professor removeSession(Session session) {
