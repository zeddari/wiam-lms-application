...
/**
 * REST controller for managing {@link com.wiam.lms.domain.Student}.
 */
@RestController
...
public class StudentResource {
    ...
    public ResponseEntity<Student> createStudent(@Valid @RequestBody Student student) throws URISyntaxException {
        ...
        studentSearchRepository.index(result);
    ...
    public ResponseEntity<Student> partialUpdateStudent(
        ...
        Optional<Student> result = studentRepository
            ...
            .map(existingStudent -> {
                ...
                if (student.getAbout() != null) {
                    existingStudent.setAbout(student.getAbout());
                }
                if (student.getImageLink() != null) {
                    existingStudent.setImageLink(student.getImageLink());
                }
                if (student.getImageLinkContentType() != null) {
                    existingStudent.setImageLinkContentType(student.getImageLinkContentType());
                }
                ...
                if (student.getLastDegree() != null) {
                    existingStudent.setLastDegree(student.getLastDegree());
                }
    ...
    public List<Student> searchStudents(@RequestParam("query") String query) {
        ...
        try {
            return StreamSupport.stream(studentSearchRepository.search(query).spliterator(), false).toList();
